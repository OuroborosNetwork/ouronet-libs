 ...
 * `@ouronet/ouronet-codex/ui`, plus a build-artifact assertion that the
 ...
 * importing `@ouronet/ouronet-codex/ui` must resolve to the barrel, and the
...
import { CodexUiRoot } from "@ouronet/ouronet-codex/ui";
...
describe("dist/ui.css build artifact", () => {
  ...
  it("is emitted by the build so consumers can import @ouronet/ouronet-codex/ui.css", () => {
